Public Class frmventas
        ...
        If Me.ValidateChildren = True And txtidcliente.Text <> "" And txtnombre_cliente.Text <> "" And txtnum_documento.Text <> "" Then
            Try
                ...
                If func.insertar(dts) Then
                    MessageBox.Show("Venta registrada con exito, proceda a añadir productos", "Guardando registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    mostrar()
                    limpiar()
                    cargar_detalle()
                ...
                Else
                    MessageBox.Show("No se realizó el registro de la venta intente de nuevo", "Guardando registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    mostrar()
                    limpiar()
                End If
    ...
    Private Sub btneditar_Click(sender As Object, e As EventArgs) Handles btneditar.Click
        ...
        result = MessageBox.Show("¿Deseas editar los datos de la venta?", "Modificando registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
            ...
            If Me.ValidateChildren = True And txtidcliente.Text <> "" And txtnum_documento.Text <> "" And txtidventa.Text <> "" Then
                Try
                    ...
                    If func.editar(dts) Then
                        MessageBox.Show("Venta modificada con exito", "Modificando registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        mostrar()
                        limpiar()
                    Else
                        MessageBox.Show("No se realizó la modificación de la venta intente de nuevo", "Modificando registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        mostrar()
                        limpiar()
                    End If
